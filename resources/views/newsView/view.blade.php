    ...
    <div class="form form-horizontal" id="form-admin-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="new_name"  id="new_name"  class="input-text">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <textarea name="new_text" id="new_text" cols="30" rows="10"></textarea>
...
<script>
    $(function () {
        ...
        $("#btn").click(function () {
            ...
            $.post(
                '/newsAdd/newsAll',
                {new_name:new_name,new_text:new_text,news_id:news_id,is_status:is_status},
                function (msg) {
                    console.log(msg)
                    if (msg.status==540){
                        alert('新闻标题不能为空')
