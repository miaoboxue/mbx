    ...
    <div class="form form-horizontal" id="form-admin-role-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$roleinfo['role_name']}}" readonly id="roleName" name="roleName">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>备注：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" value="{{$roleinfo['content']}}" id="content">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <dl class="permission-list">
                    <dt>
                        <label>
                            @if(in_array($v['action_id'],$powerinfo)==true)
                            <input type="checkbox" checked value="{{$v['action_id']}}" name="user-Character-0" id="user-Character-0">{{$v['action_name']}}
                            @else
                    ...
                    <dl class="cl permission-list2">
                        <dd>
                            <label class="">
                                @if(in_array($value['action_id'],$powerinfo)==true)
                                <input type="checkbox" value="{{$value['action_id']}}" checked name="user-Character-0-1-0" id="user-Character-0-1-0">
                                {{$value['action_name']}}
                                 @else
