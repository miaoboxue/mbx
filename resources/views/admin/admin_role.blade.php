    ...
    <div class="form form-horizontal" id="form-admin-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" readonly  name="adminName" value="{{$uname}}">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                @foreach($data as $keys=>$value)
                    <label class="">
                        @if(in_array($value['role_id'],$adminrole)==true)
                            <input type="checkbox" value="{{$value['role_id']}}" checked name="user-Character-0-1-0" id="user-Character-0-1-0">
                            {{$value['role_name']}}
                        @else
