    ...
    <div class="form form-horizontal" id="form-admin-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="nav_name"  id="name_nav"  class="input-text">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" name="nav_url"  id="nav_url"  class="input-text">
    ...
    <script>
       $(function () {
           ...
           $("#btn").click(function () {
               ...
               $.post(
                   '/nav/all',
                   {nav_name:nav_name,nav_url:nav_url,status:status},
                   function (msg) {
                       console.log(msg)
                       if(msg.status==5400){
                            alert('导航栏名称不能为空')
