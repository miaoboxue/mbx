...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray">
        <span class="l"> <a href="javascript:;" onclick="datadel()" class="btn btn-danger radius">
            ...
            <a class="btn btn-primary radius" href="/nav/navview">
                <i class="Hui-iconfont">&#xe600;</i> 添加导航栏 </a>
        </span>
    ...
    <table class="table table-border table-bordered table-hover table-bg">
        <thead>
        <tr>
            <th scope="col" colspan="6">导航栏管理</th>
        </tr>
        <tr class="text-c">
            <th width="25"><input type="checkbox" value="" name=""></th>
            <th width="40">ID</th>
            <th width="200">导航栏名称</th>
            <th width="300">导航栏地址</th>
        ...
        @foreach($arr as $k=>$v)
            <tr class="text-c">
                ...
                @endif
                <td class="f-14">
                    <a title="编辑" href="/nav/update/{{$v['nav_id']}}">
                        <i class="Hui-iconfont">&#xe6df;</i>
                    </a>
                    <a title="删除" href="javascript:;"  nav_id="{{$v['nav_id']}}" class="del">
                        <i class="Hui-iconfont">&#xe6e2;</i>
                    </a>
                </td>
            </tr>
